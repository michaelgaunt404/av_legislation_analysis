...
Need to figure out a way to structure so that running multiple analysis is easier. Want to run this with more bigrams but it is hard to do so given current data strucutre. 
